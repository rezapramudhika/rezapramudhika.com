        ...
        if (window.innerWidth <= 500) {
            return (
                <div style={styles.container}>
                    ...
                    deepen this field. Therefore, I decided to join <a style={{textDecoration:'none'}} href='https://hacktiv8.com' target='_blank' rel="noopener noreferrer">Hacktiv8</a> in December 2017. I learned a lot of new technology
            ...
            return (
                <div style={styles.containerWeb}>
                    ...
                    Since I was a graduate, I did some projects in terms of creating and managing
                    mobile application. I have a very high interest in programming and I feel like to
                    deepen this field. Therefore, I decided to join <a style={{textDecoration:'none'}} href='https://hacktiv8.com' target='_blank' rel="noopener noreferrer">Hacktiv8</a> Indonesia in December 2017. I learned a lot of new technology
                    related to web development.
